...
type Config struct {
	...
	VnPay struct {
		...
		ErrorUrl   string `envconfig:"VNPAY_ERROR_URL" default:"http://localhost:3000/payment/error"`
	}
	PayPal struct {
		...
		SuccessUrl string `envconfig:"PAYPAL_SUCCESS_URL" default:"http://localhost:3000/payment/received"`
	}
